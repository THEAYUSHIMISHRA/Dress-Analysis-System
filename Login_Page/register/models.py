...
class UserTransactions(models.Model):
    ...
    dress_accuracy = models.DecimalField(max_digits=5, decimal_places=2)
    is_properly_dressed = models.BooleanField(blank=True, null=True)
...
# ✅ ADDITIONAL MODEL for Step 6 (Role-based access)
